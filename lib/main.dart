...
import 'package:keuangan/db/database_instance.dart';
import 'package:keuangan/models/transaksi_model.dart';
import 'package:keuangan/screens/create_screen.dart';
import 'package:keuangan/screens/update_screen.dart';
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    if (snapshot.hasData) {
                      return Text(
                          "Total Picis Masuk : Rp. ${snapshot.data.toString()}");
                    } else {
                      return Text("");
                    }
                  }
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    if (snapshot.hasData) {
                      return Text(
                          "Total Picis Keluar : Rp. ${snapshot.data.toString()}");
                    } else {
                      return Text("");
                    }
                  }
